 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 5, 67 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -5   // Z offset: -below +above  [the nozzle] //luojin
#else
...
#define Z_SAFE_HOMING
  ...
  //#define Z_SAFE_HOMING_X_POINT ((26) ) /// 269   // X point for Z homing when homing all axes (G28).
  //#define Z_SAFE_HOMING_Y_POINT ((295) )    // Y point for Z homing when homing all axes (G28).
#endif
